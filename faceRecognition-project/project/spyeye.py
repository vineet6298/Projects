...
face_cascade = cv2.CascadeClassifier('C:/Users/Vineet/Desktop/faceRecognition-project/project/haarcascade_frontalface_default.xqml') 
cap = cv2.VideoCapture(0)   # 0 = main camera , 1 = extra connected webcam and so on.
rec = cv2.face.LBPHFaceRecognizer_create()

#the path where the code is saved
pathz = "C:\\Users\\Vineet\\Desktop\\faceRecognition-project\\project" #get path of the software
...
def recog():
    ...
    #print("Starting")
    rec.read(f"{pathz}\\chikoneye.yml")  #yml file location 
